...
std::vector<std::vector<double>> identityMatrix(const std::vector<std::vector<double>>& matrix, int size);

std::vector<std::vector<double>> inverseMatrix(const std::vector<std::vector<double>>& matrix);

double condMatrix(const std::vector<std::vector<double>>& A, double(*normMatrix)(const std::vector<std::vector<double>>&));
